...
##################################################### DECLARATION OF VARIABLES AND DATATYPES #########################################################################  
    ...
    #==========================================Define Functiom==================================================
        ...
        def receipt():
            if reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                self.txtReceipt2.insert(END, 'MH ' + Receipt_Ref.get() + " BW\n")
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',50,'bold'),text=" 🚕🚕Taxi Booking System in KJSCE🚕🚕 ")
        self.lblTitle.grid(padx=140,pady=50)

    #================================================customerframedetail=============================================================
        CustomerDetailsFrame=LabelFrame(MainFrame, width=1350,height=500,bd=10, pady=5, relief=RIDGE)
